				...
				<ul class="login-dropdown" role="menu">
					<li>
						<div class="login-item">
							...
							<img class="img-responsive img-rounded" src="${pageContext.request.contextPath}/resources/img/nav-menu/nav1.jpg" alt="" />
					...
					<li>
						<div class="login-item">
							<a href="#"><i class="fa fa-times"></i></a>
							<img class="img-responsive img-rounded" src="${pageContext.request.contextPath}/resources/img/nav-menu/nav2.jpg" alt="" />
					...
					<li>
						<div class="login-item">
							<a href="#"><i class="fa fa-times"></i></a>
							<img class="img-responsive img-rounded" src="${pageContext.request.contextPath}/resources/img/nav-menu/nav3.jpg" alt="" />
