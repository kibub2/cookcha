		...
		<div class="row">
			<div class="col-md-4 col-sm-4">
				...
				<div class="chefs-member">
					...
					<div class="chefs-head">
						...
						<img class="chefs-back img-responsive" src="resources/img/chef/c-back2.jpg" alt="" />
						<!-- chef member image -->
			...
			<div class="col-md-4 col-sm-4">
				...
				<div class="chefs-member">
					...
					<div class="chefs-head">
						<!-- Member background image -->
						<img class="chefs-back img-responsive" src="resources/img/chef/c-back1.jpg" alt="" />
						<!-- chef member image -->
			...
			<div class="col-md-4 col-sm-4">
				...
				<div class="chefs-member">
					...
					<div class="chefs-head">
						<!-- Member background image -->
						<img class="chefs-back img-responsive" src="resources/img/chef/c-back3.jpg" alt="" />
						<!-- chef member image -->
