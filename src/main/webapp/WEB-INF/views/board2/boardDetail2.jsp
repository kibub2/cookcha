	...
	<div style="width: 55.5%; margin-top: 50px;">
		<table>
			<tbody>
				...
				<tr>
					<td>
						<i class="fa fa-user" aria-hidden="true"></i>&nbsp;${board2.id}
					</td>
				</tr>
			</tbody>
		...
		<div style="margin-top: 20px;">
			<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/board2/boardUpdate2.do'">수정</button>
