...
<div class="container-fluid" align="center" style="padding-bottom: 50px;margin-top: 20px;width: 95%;background-color: white;box-shadow: #D5D5D5 0 1px 5px;">
	...
	<div>
		<c:if test="${userId == '2@test.com'}">
			<button type="button" class="btn btn-primary" onclick="location.href='${pageContext.request.contextPath}/board2/boardWrite2.do'">글 작성</button>
		</c:if>
