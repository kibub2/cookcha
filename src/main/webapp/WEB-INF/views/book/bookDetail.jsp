						...
						<div class="col-md-4 col-sm-4">
							...
							<div class="btn-cart-md">
								<a class="cart-link" href="#"> <!-- Image --> <img
									...
									<h4>Shopping Cart</h4> <span>3 items $489/-</span>
						...
						<div class="col-md-4">
							...
							<div class="booking-form">
								...
								<form:form role="form" action="bookDetail.do" commandName="command">
									...
									<div class="form-group">
										<!-- Form text area -->
										<form:textarea class="form-control" rows="3" placeholder="내용입력" path="content"></form:textarea>
									</div>
									<!-- Form button -->
					...
					<div class="col-md-3 col-sm-6">
						...
						<div class="footer-widget">
							...
							<a href="#"><img class="payment img-responsive"
								...
								class="payment img-responsive" src="img/payment/mastercard.gif"
								alt="" /></a> <a href="#"><img class="payment img-responsive"
								src="img/payment/paypal.gif" alt="" /></a> <a href="#"><img
								class="payment img-responsive" src="img/payment/visa.gif" alt="" /></a>
							<a href="#"><img class="payment img-responsive"
								src="img/payment/worldpay.gif" alt="" /></a>
						</div>
						<!--/ Footer widget end -->
					</div>
					<div class="col-md-3 col-sm-6">
