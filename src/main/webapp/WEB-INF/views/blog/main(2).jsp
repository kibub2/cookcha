...
<!-- Inner Content -->
			<div class="inner-page padd" style="margin:0 auto;">
					...
					<div class="container">
						...
						<div class="shopping-content">
							<div class="row">
								...
								<h3 align="center">회원님이 방문한 맛집</h3>
								
								<div class="col-md-3 col-sm-6">
									<!-- Shopping items -->
									<div class="shopping-item">
										<!-- Image -->
										<a href="item-single.html"><img class="img-responsive" src="${pageContext.request.contextPath }/resources/img/shopping/shop1.jpg" alt="" /></a>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="item-single.html"><img class="img-responsive" src="${pageContext.request.contextPath }/resources/img/shopping/shop2.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="item-single.html"><img class="img-responsive" src="${pageContext.request.contextPath }/resources/img/shopping/shop3.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="item-single.html"><img class="img-responsive" src="${pageContext.request.contextPath }/resources/img/shopping/shop4.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="item-single.html"><img class="img-responsive" src="${pageContext.request.contextPath }/resources/img/shopping/shop5.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="shopping-item">
										<!-- Image -->
										<a href="item-single.html"><img class="img-responsive" src="${pageContext.request.contextPath }/resources/img/shopping/shop6.jpg" alt="" /></a>
										<!-- Shopping item name / Heading -->
