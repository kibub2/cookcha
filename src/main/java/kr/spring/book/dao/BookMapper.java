...
public interface BookMapper {
	...
	@Insert("INSERT INTO book (seq, id, name, book_date, book_time, code, phone, seat, content) VALUES (book_seq.nextval, #{id}, #{name}, #{book_date}, #{book_time, jdbcType=VARCHAR}, 1, #{phone}, #{seat}, #{content})")
